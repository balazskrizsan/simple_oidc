...
import com.kbalazsworks.simple_oidc.common.services.ApplicationPropertiesService
...
class HttpClientFactory(private val applicationPropertiesService: ApplicationPropertiesService) {
    ...
    private fun getSslContext(): SSLContext {
        ...
        return SSLContextBuilder
            ...
            .loadKeyMaterial(
                keyStore("W:\\Java\\simple_oidc\\src\\main\\resources\\keystore\\sjdev.p12", password),
                password
            )
